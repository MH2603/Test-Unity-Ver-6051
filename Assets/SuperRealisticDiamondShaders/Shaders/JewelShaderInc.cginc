 ...
 //   if (UV.x == 3)
  ...
  //  [unroll(10)]
   ...
   /*     DispersionR = DispersionR / (tmpRayDirection - Depth_) ;
    ...
    float4 tmpReflectionColor = float4(1, 1, 1, 1);
   ...
   //     tmpReflectionColor = (0.2 + tmpReflectionColor) / 1.2;
        float4 refractionColors_;
            ...
            tmpReflectionColor = lerp(lerp(refractionColors2[j], tmpReflectionColor, reflectionRates[j]) * depthColors[j], colorRuby,RubyMist);
